export default {
  ...
  'add-info': 'Roles Manage',
  'indexLog': 'Operation Log',
  'edit-password': 'Edit Password',
  'form-day': 'Channel daily report',
  'form-momth': 'Monthly channel report',
  'form-bill': 'Channel bills',
  'form-day-child': 'Subchannel daily report',
  'form-month-child': 'Subchannel monthly report',
  store: 'Store',
  exception: 'Exception',
  'store-online': 'Online order audit',
  'store-offline': 'Offline order audit',
  join_page: 'QQ Group',
